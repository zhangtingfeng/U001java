        ...
        <div class="order-list">
            ...
            <div class="lr-padding">
                <template v-for="(service, i) in services">
                    <div class="order-item" :key="service.id" v-if="service.state1 == state || state == '0'">
                        ...
                        <div class="oneListline">
                            <div class="headerline">
                                ...
                                <span>售后类型 : {{ (service.buyeraftermarkettype) }}</span>
                            ...
                            <div class="dateailline">
                                ...
                                <span>卖家机构 : {{ service.sellers ? service.sellers.orgName : "" }}</span>
                                <span>卖家电话 : {{ service.sellers ? service.sellers.mobile : "" }}</span>
                            </div>
    ...
    export default {
        ...
        methods: {
            async init() {
                ...
                this.serviceSearchTime.buyerOrSeller = "buyer";
            ...
            async iniQuery(orderSearchTime) {
                try {
                    let data = await ajax.post({
                        url: "api/order/aftermarketinfo/getServicesList?buyerOrSeller=buyer",
                        ...
                        if (data.services.length == 0) {
                            ...
                            for (var service of data.services) {
                                ...
                                for (let i = 0; i < ddddata.length; i++) {
                                    //debugger;
                                    if (ddddata[i].id == service.state1) {
