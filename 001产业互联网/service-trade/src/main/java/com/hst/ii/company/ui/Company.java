...
import com.hst.ii.company.proxy.CompanyProxy;
import lombok.Data;
...
@Data
@NoArgsConstructor
@EInfo(name = "company", title = "公司信息", entity = TCompany.class, proxy = CompanyProxy.class, children = {"account", "member"})
public class Company extends MetaData {
    ...
    @EField(title = "企业名称", query = FieldQuery.LIKE, group = "企业信息", validate = "required")
