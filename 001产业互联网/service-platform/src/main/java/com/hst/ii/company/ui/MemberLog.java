...
public class MemberLog extends MetaData {
    ...
    @EField(title = "成员类型", viewer = "dict.mbrTyp", editor = "select.mbrTyp", validate = "required", form = 1)
    private String mbrTyp;

    @EField(title = "成员姓名", validate = "required", form = 1)
    private String mbrNam;

//    @EField(title = "国籍")
//    private String mbrNtn;

    @EField(title = "证件类型", viewer = "dict.docTyp", editor = "select.docTyp", form = 1)
    private String docTyp;

    @EField(title = "证件号码", form = 1)
    private String docNbr;

//    @EField(title = "证件有效期", editor = "date")
//    private Date docVld;

    @EField(title = "联系电话", validate = "required", form = 1)
    private String mbrTel;

    @EField(title = "联系地址", form = 1)
