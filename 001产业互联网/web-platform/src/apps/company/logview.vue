      ...
      <div class="col-md-12">
        <div class="panel panel-default">
          ...
          <div class="panel-footer">
            <label class="control-label" v-if="result">审批结果：{{result=="1"?'审批通过':'审批退回'}}</label>
            <label class="control-label" v-else>审核中</label>
            <hr />
...
import ChildTable from "./approve/ChildTable";
