...
public class CodeUtil {
    ...
    private static final String SMS_CODE_RANDOM_CHAR_DICT = "0123456789";
    /**
     * 生成验证码
     * @param length
     * @return
    ...
    public static String genNumString(int length) {
        ...
        for (int i = 0; i < length; i++) {
            sb.append(SMS_CODE_RANDOM_CHAR_DICT.charAt(random.nextInt(SMS_CODE_RANDOM_CHAR_DICT.length())));
        }
        return sb.toString();
    }
