 ...
 */
public class ActivityFullProduct implements Serializable{
    ...
    public Integer getFullNums() {
        return fullNums;
    }

    public void setFullNums(Integer fullNums) {
