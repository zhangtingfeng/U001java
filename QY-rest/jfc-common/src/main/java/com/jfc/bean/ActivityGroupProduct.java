 ...
 */
public class ActivityGroupProduct implements Serializable{
    ...
    public Integer getFullNumbers() {
        return fullNumbers;
    }

    public void setFullNumbers(Integer fullNumbers) {
